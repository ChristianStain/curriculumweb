    ...
    <div class="container resume">
      <h2>My Resume</h2>
      <h3>You can download my resume for your reference and I hope that we will meet very soon! :D</h3>
      <div class="btn-center"> <a href="ChristianMancha_RESUME.docx" class="hire-me"><i class="icon-download"></i> Download Resume</a>
        <h2>17kb</h2>
      </div>
    </div>
